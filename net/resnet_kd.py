...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        fc7=self.fc7(feat)
        fc8=self.fc8(feat)
        fc_emotion=self.fc_emotion(feat)
        ...
        return x, conv0, conv2, conv3, conv4, conv5, feat,fc1,fc2,fc3,fc4,fc5,fc6,fc7,fc8,fc_emotion
        #return feat
...
def resnet18(pretrained=True, **kwargs):
    ...
    if pretrained:
        ...
        classifier_model = MODEL_PATH + '/resnet18-5c106cde.pth'   
...
def resnet34(pretrained=True, **kwargs):
    ...
    if pretrained:
        ...
        MODEL_PATH = '/research/tklab/personal/ytli/pytorch RES3D CVPR2018/FAb-Net-master/FAb-Net/AUs_xuesong/MLCR-master/model'
        classifier_model = MODEL_PATH + '/resnet34-333f7ec4.pth'   
        pretrain=torch.load(classifier_model)
        model_dict =  model.state_dict()
