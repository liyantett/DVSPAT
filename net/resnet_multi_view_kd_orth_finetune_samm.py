...
class ResNet_GCN_two_views(nn.Module):
    ...
    def forward(self, data):
        ...
        output1, conv1, conv2, conv3, conv4, conv5, feat1,fc1,fc2,fc3,fc4= self.net1(data);
        output2, conv10, conv20, conv30, conv40, conv50,feat2,fc10,fc20,fc30,fc40= self.net2(data);
