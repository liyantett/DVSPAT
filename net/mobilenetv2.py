...
def mobilenetv2(**kwargs):
    ...
    MODEL_PATH = '/research/tklab/personal/ytli/pytorch RES3D CVPR2018/FAb-Net-master/FAb-Net/mobilenetv2.pytorch-master'    
    classifier_model = MODEL_PATH + '/mobilenetv2_1.0-0c6065bc.pth'     
