...
class Senet50_128(nn.Module):
    ...
    def __init__(self):
        ...
        self.image_num=1
        '''
        self.fc_1=nn.Sequential(nn.ReLU(inplace=True), nn.Linear(self.inner_nc, 2, bias=False))
        self.fc_2=nn.Sequential(nn.ReLU(inplace=True), nn.Linear(self.inner_nc, 2, bias=False))
        self.fc_3=nn.Sequential(nn.ReLU(inplace=True), nn.Linear(self.inner_nc, 2, bias=False))
        self.fc_4=nn.Sequential(nn.ReLU(inplace=True), nn.Linear(self.inner_nc, 2, bias=False))
        self.fc_5=nn.Sequential(nn.ReLU(inplace=True), nn.Linear(self.inner_nc, 2, bias=False))
        self.fc_6=nn.Sequential(nn.ReLU(inplace=True), nn.Linear(self.inner_nc, 2, bias=False))
        self.fc_7=nn.Sequential(nn.ReLU(inplace=True), nn.Linear(self.inner_nc, 2, bias=False))
        self.fc_8=nn.Sequential(nn.ReLU(inplace=True), nn.Linear(self.inner_nc, 2, bias=False))
        '''


        
        self.feat_extract_relu = nn.ReLU(inplace=True)
        self.feat_extract_bn= nn.BatchNorm1d(self.inner_nc)

        '''
        self.fc_1=nn.Sequential(nn.BatchNorm1d(self.inner_nc), nn.Linear(self.inner_nc, 2, bias=False))
        self.fc_2=nn.Sequential(nn.BatchNorm1d(self.inner_nc), nn.Linear(self.inner_nc, 2, bias=False))
        self.fc_3=nn.Sequential(nn.BatchNorm1d(self.inner_nc), nn.Linear(self.inner_nc, 2, bias=False))
        self.fc_4=nn.Sequential(nn.BatchNorm1d(self.inner_nc), nn.Linear(self.inner_nc, 2, bias=False))
        self.fc_5=nn.Sequential(nn.BatchNorm1d(self.inner_nc), nn.Linear(self.inner_nc, 2, bias=False))
        self.fc_6=nn.Sequential(nn.BatchNorm1d(self.inner_nc), nn.Linear(self.inner_nc, 2, bias=False))
        self.fc_7=nn.Sequential(nn.BatchNorm1d(self.inner_nc), nn.Linear(self.inner_nc, 2, bias=False))
        self.fc_8=nn.Sequential(nn.BatchNorm1d(self.inner_nc), nn.Linear(self.inner_nc, 2, bias=False))
        
        '''
        self.feat_extract_relu = nn.ReLU(inplace=True)
        self.feat_extract_bn= nn.BatchNorm1d(self.inner_nc)

        self.feat_extract2 = nn.Linear(self.inner_nc*self.image_num, 2, bias=False)
        self.fc_1=nn.Linear(self.inner_nc*self.image_num, 2, bias=False)
        self.fc_2=nn.Linear(self.inner_nc*self.image_num, 2, bias=False)
        self.fc_3=nn.Linear(self.inner_nc*self.image_num, 2, bias=False)
        self.fc_4=nn.Linear(self.inner_nc*self.image_num, 2, bias=False)
        self.fc_5=nn.Linear(self.inner_nc*self.image_num, 2, bias=False)
        self.fc_6=nn.Linear(self.inner_nc*self.image_num, 2, bias=False)
        self.fc_7=nn.Linear(self.inner_nc*self.image_num, 2, bias=False)
        self.fc_8=nn.Linear(self.inner_nc*self.image_num, 2, bias=False)
        self.fc_emotion=nn.Linear(self.inner_nc*self.image_num, 5, bias=True)
    ...
    def forward(self, data):
        ...
        #feat_extract=self.feat_extract_relu(feat_extract)
        feat_extract= self.feat_extract_bn(feat_extract)  
        return feat_extract, conv5_3x
