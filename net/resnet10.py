...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=5, ave_size=7, num_output = 66):
        self.inplanes = 64
	...
	self.fc_2 = nn.Linear(512 * block.expansion, 2)
	self.fc_3 = nn.Linear(512 * block.expansion, 2)
	self.fc_4 = nn.Linear(512 * block.expansion, 2)
	self.fc_5 = nn.Linear(512 * block.expansion, 2)
	self.fc_6 = nn.Linear(512 * block.expansion, 2)
	self.fc_7 = nn.Linear(512 * block.expansion, 2)
	self.fc_8 = nn.Linear(512 * block.expansion, 2)
	...
	self.fc6 = nn.Linear(512 * block.expansion, 2)
	self.fc7 = nn.Linear(512 * block.expansion, 2)
	self.fc8 = nn.Linear(512 * block.expansion, 2)
        self.fc_emotion = nn.Linear(512 * block.expansion, 5)
    ...
    def forward(self, x):
        ...
        return x, conv0, conv2, conv3, conv4, conv5, feat
        #return feat
